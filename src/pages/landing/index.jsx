    ...
    return (
        <div className="App">
            <header className={darkMode ? 'App-header-dark' : 'App-header-light'}>
                ...
                <IconButton borderRadius='50%' aria-label='dark mode switch' color='black' className={darkMode ? 'landing__darkMode-btn' : 'landing__darkMode-btn-light'} onClick={handleMode} icon={darkMode ? <SunIcon /> : <MoonIcon />} />
