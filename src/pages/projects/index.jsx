...
const Projects = () => {
    ...
    return (
        <div className={darkMode ? 'about__container container-dark' : 'about__container container-light'}>
            ...
            <a style={{ paddingBottom: '35px' }} className={darkMode ? 'App-link' : 'App-link light'} href='https://dtellz.github.io/self-driving-car/'>Self driving car - Reinforcement learning neural network with vanillaJs</a>
